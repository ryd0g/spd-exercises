...
fits_eye = eye_size > 0.45
fits_iris = (math.pi*iris_width / 2*iris_height/2) / eye_size >= 0.69
fits_ratio = eye_height / eye_width >= 0.59

if fits_eye and fits_iris and fits_ratio:
